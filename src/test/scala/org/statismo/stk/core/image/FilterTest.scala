...
//
//      val grid = DiscreteImageDomain(gf.support.origin, (gf.support.extent) * (1.0 / 1000), Index(1000))
//
...
//
//      val grid = DiscreteImageDomain(gf.support.origin, (gf.support.extent) * (1.0 / 600), Index(601, 601))
//
...
//      val grid = DiscreteImageDomain(gf.support.origin, (gf.support.extent) * (1.0 / 200), Index(200, 200, 200))
//
