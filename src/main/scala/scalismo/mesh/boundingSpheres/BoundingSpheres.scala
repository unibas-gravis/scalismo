 ...
 */
private[mesh] abstract class BoundingSphere(val center: SpatialVector[_3D],
    val r2: Double,
    val idx: Int,
...
private[mesh] object BoundingSpheres {
   ...
   */
  def calculateNearestPointPairs(points: Seq[SpatialVector[_3D]]): Seq[Int] = {
   ...
   */
  @tailrec
  final def matchPoints(points: Seq[(SpatialVector[_3D], Int)], matchedPoints: Array[Int]): Unit = {
    points.length match {
   ...
   */
  @inline
  def choosePointPairsAndUpdateMatchedIndex(closestPointPairs: Seq[(Double, Int, ((SpatialVector[_3D], Int), Int))],
    sortedPoints: Seq[(SpatialVector[_3D], Int)],
   ...
   */
  @inline
  def findClosestPointPairs(sortedPoints: Seq[(SpatialVector[_3D], Int)]) = {
 ...
 */
private class BoundingSphereSplit(center: SpatialVector[_3D],
  r2: Double,
  idx: Int,
  left: BoundingSphere,
 ...
 */
private class BoundingSphereLeave(center: SpatialVector[_3D],
  r2: Double,
  idx: Int)
 ...
 */
private case class Sphere(center: SpatialVector[_3D], r2: Double)
...
private object Sphere {
   ...
   */
  def triangleCircumSphere(a: SpatialVector[_3D], b: SpatialVector[_3D], c: SpatialVector[_3D]): (SpatialVector[_3D], Double) = {
