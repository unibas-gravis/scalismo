...
object MeshMetrics {
  ...
  /**
    * For each point of the first tetrahedral mesh, this method computes the shortest distance to the grid of the
    * second tetrahderal mesh and returns the average over all points
    */
  ...
  /**
    * Computes a distance image for each tetrahedral mesh and returns the Dice Coefficient between the two images
    */
