...
case class PointsWithLikelyCorrespondenceSampler(gp: GaussianProcess[_3D, SpatialVector[_3D]], refmesh: TriangleMesh[_3D], targetMesh: TriangleMesh[_3D], maxMd: Double) extends Sampler[_3D] {
