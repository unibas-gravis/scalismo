...
object LinearImageInterpolator {
  ...
  implicit def linearImageInterpolator1D[A: ValueInterpolator]: LinearImageInterpolator1D[A] = LinearImageInterpolator1D[A]()

  implicit def linearImageInterpolator2D[A: ValueInterpolator]: LinearImageInterpolator2D[A] = LinearImageInterpolator2D[A]()

  implicit def linearImageInterpolator3D[A: ValueInterpolator]: LinearImageInterpolator3D[A] = LinearImageInterpolator3D[A]()
}
