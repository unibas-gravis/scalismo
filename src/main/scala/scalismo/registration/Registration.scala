...
/**
 * Implementation of a gradient-based registration algorithm, whose cost function is defined by the sum of a distance
 * metric and a regularization term (weighted by a regularizationWeight).
 *
 * @param metric
