...
class GaussianProcessTransformationSpace[D] private (gp: LowRankGaussianProcess[D, Vector[D]])(implicit vectorizer: VectorVectorizer[D])
...
class GaussianProcessTransformation[D] private (gp: LowRankGaussianProcess[D, Vector[D]], alpha: ParameterVector)
...
object GaussianProcessTransformation {
  def apply[D](gp: LowRankGaussianProcess[D, Vector[D]], alpha: TransformationSpace.ParameterVector) = {
    new GaussianProcessTransformation[D](gp, alpha)
  }
}

object GaussianProcessTransformationSpace {
  def apply[D](gp: LowRankGaussianProcess[D, Vector[D]])(implicit vectorizer: VectorVectorizer[D]) = {
