 ...
 */
case class TranslationTransform[D: NDSpace](t: Vector[D]) extends ParametricTransformation[D] with CanInvert[D] with CanDifferentiate[D] {
 ...
 */
case class AnisotropicScalingTransformation[D: NDSpace](s: geometry.Vector[D]) extends ParametricTransformation[D] with CanInvert[D] with CanDifferentiate[D] {
  override val domain = RealSpace[D]
