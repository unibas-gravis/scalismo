 ...
 */
case class CompositeTransformation[D <: Dim](outerTransform: ParametricTransformation[D] with CanDifferentiate[D], innerTransform: ParametricTransformation[D] with CanDifferentiate[D]) extends ParametricTransformation[D] with CanDifferentiate[D] {
 ...
 */
case class TranslationTransform[D <: Dim: NDSpace](t: EuclideanVector[D]) extends ParametricTransformation[D] with CanInvert[D] with CanDifferentiate[D] {
 ...
 */
trait RigidTransformation[D <: Dim] extends CompositeTransformation[D] with CanInvert[D] {
...
object RigidTransformation {
  ...
  def apply[D <: Dim: NDSpace](translationTransform: TranslationTransform[D], rotationTransform: RotationTransform[D]): RigidTransformation[D] =
...
private class RigidTransformationRotationFollowingTranslation[D <: Dim: NDSpace](val rotation: RotationTransform[D], val translation: TranslationTransform[D])
...
trait SimilarityTransformation[D <: Dim] extends CompositeTransformation[D] with CanInvert[D] {
...
object SimilarityTransformation {
   ...
   * @return
   */
  def apply[D <: Dim: NDSpace](scaling: ScalingTransformation[D], rigidTransformation: RigidTransformation[D]): SimilarityTransformation[D] = {
    new SimilarityTransformationScalingFollowingRigid[D](scaling, rigidTransformation)
  }
  def apply[D <: Dim: NDSpace](rigidTransformation: RigidTransformation[D], scaling: ScalingTransformation[D]): SimilarityTransformation[D] = {
    new SimilarityTransformationRigidFollowingScaling[D](rigidTransformation, scaling)
  }
}

private class SimilarityTransformationScalingFollowingRigid[D <: Dim: NDSpace](val scaling: ScalingTransformation[D],
 ...
 */
case class AnisotropicScalingTransformation[D <: Dim: NDSpace](s: geometry.EuclideanVector[D]) extends ParametricTransformation[D] with CanInvert[D] with CanDifferentiate[D] {
  override val domain = RealSpace[D]
 ...
 *
 */
trait AnisotropicSimilarityTransformation[D <: Dim] extends CompositeTransformation[D] with CanInvert[D]

private class RigidTransformationThenAnisotropicScaling[D <: Dim: NDSpace](anisotropicScaling: AnisotropicScalingTransformation[D], rigidTransform: RigidTransformation[D])
...
private class AnisotropicScalingThenRigidTransformation[D <: Dim: NDSpace](rigidTransform: RigidTransformation[D], anisotropicScaling: AnisotropicScalingTransformation[D])
