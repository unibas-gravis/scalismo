 ...
 */
class DifferentiableProductTransformationSpace[D, OT <: ParametricTransformation[D] with CanDifferentiate[D], IT <: ParametricTransformation[D] with CanDifferentiate[D]] private[registration] (outer: TransformationSpace[D] with DifferentiableTransforms[D], inner: TransformationSpace[D] with DifferentiableTransforms[D]) extends TransformationSpace[D] with DifferentiableTransforms[D] {
  ...
  override def transformForParameters(p: ParameterVector) = {
    ...
    new DifferentiableCompositeTransformation(outer.transformForParameters(outerParams), inner.transformForParameters(innerParams))
  }
...
object DifferentiableProductTransformationSpace {
  def apply[D, OT <: ParametricTransformation[D] with CanDifferentiate[D], IT <: ParametricTransformation[D] with CanDifferentiate[D]](
    outer: TransformationSpace[D] with DifferentiableTransforms[D],
    inner: TransformationSpace[D] with DifferentiableTransforms[D]): DifferentiableProductTransformationSpace[D, OT, IT] = {
 ...
 * @tparam IT Type of the inner transformation space. This space must generate differentiable parametric transforms
 */
class ProductTransformationSpace[D, OT <: ParametricTransformation[D] with CanDifferentiate[D], IT <: ParametricTransformation[D]] private[registration] (outer: TransformationSpace[D] with DifferentiableTransforms[D], inner: TransformationSpace[D]) extends TransformationSpace[D] {
...
object ProductTransformationSpace {
  def apply[D, OT <: ParametricTransformation[D] with CanDifferentiate[D], IT <: ParametricTransformation[D]](
    outer: TransformationSpace[D] with DifferentiableTransforms[D],
    inner: TransformationSpace[D]): ProductTransformationSpace[D, OT, IT] = {
 ...
 */
case class DifferentiableCompositeTransformation[D](outerTransform: ParametricTransformation[D] with CanDifferentiate[D], innerTransform: ParametricTransformation[D] with CanDifferentiate[D]) extends ParametricTransformation[D] with CanDifferentiate[D] {
 ...
 *  @param outerTransform transform to be applied second. Must be a parametric differentiable transform
 */
case class CompositeTransformation[D](outerTransform: ParametricTransformation[D], innerTransform: ParametricTransformation[D]) extends ParametricTransformation[D] {
...
class RigidTransformationSpace[D: NDSpace: CreateRotationSpace] private (center: Point[D])
  extends DifferentiableProductTransformationSpace[D, TranslationTransform[D], RotationTransform[D]](TranslationSpace[D], RotationSpace[D](center)) {
...
private class RigidTransformationTranslationFollowingRotation[D: NDSpace](val translation: TranslationTransform[D], val rotation: RotationTransform[D])
  extends DifferentiableCompositeTransformation[D](translation, rotation) with RigidTransformation[D] {
...
private class RigidTransformationRotationFollowingTranslation[D: NDSpace](val rotation: RotationTransform[D], val translation: TranslationTransform[D])
  extends DifferentiableCompositeTransformation[D](rotation, translation) with RigidTransformation[D] {
...
private class SimilarityTransformationScalingFollowingRigid[D: NDSpace](
  val scaling: ScalingTransformation[D],
  val rigidTransformation: RigidTransformation[D])
  extends DifferentiableCompositeTransformation[D](scaling, rigidTransformation) with SimilarityTransformation[D] {
...
private class SimilarityTransformationRigidFollowingScaling[D: NDSpace](
  val rigidTransformation: RigidTransformation[D],
  val scaling: ScalingTransformation[D])
  extends DifferentiableCompositeTransformation[D](rigidTransformation, scaling) with SimilarityTransformation[D] {
...
case class SimilarityTransformationSpace[D: NDSpace: CreateRotationSpace: ScalingSpace.Create](center: Point[D])
  extends DifferentiableProductTransformationSpace[D, ScalingTransformation[D], RigidTransformation[D]](ScalingSpace[D](), RigidTransformationSpace[D](center)) {
...
private class RigidTransformationThenAnisotropicScaling[D: NDSpace](anisotropicScaling: AnisotropicScalingTransformation[D], rigidTransform: RigidTransformation[D])
  extends DifferentiableCompositeTransformation[D](anisotropicScaling, rigidTransform) with AnisotropicSimilarityTransformation[D] {
...
private class AnisotropicScalingThenRigidTransformation[D: NDSpace](rigidTransform: RigidTransformation[D], anisotropicScaling: AnisotropicScalingTransformation[D])
  extends DifferentiableCompositeTransformation[D](rigidTransform, anisotropicScaling) with AnisotropicSimilarityTransformation[D] {
...
case class AnisotropicSimilarityTransformationSpace[D: NDSpace: CreateRotationSpace](center: Point[D])
  extends DifferentiableProductTransformationSpace[D, RigidTransformation[D], AnisotropicScalingTransformation[D]](RigidTransformationSpace[D](center), AnisotropicScalingSpace[D]()) {
