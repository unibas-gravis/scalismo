...
object MHProductProposal {
  def apply[A, B](a : MHProposalGenerator[A], b : MHProposalGenerator[B]) : MHProductProposal2[A, B] = new MHProductProposal2(a, b)
  def apply[A, B, C](a : MHProposalGenerator[A], b : MHProposalGenerator[B], c : MHProposalGenerator[C]) : MHProductProposal3[A, B, C] = new MHProductProposal3(a, b, c)
}


class MHProductProposal2[A, B](proposal1: MHProposalGenerator[A],
                               proposal2: MHProposalGenerator[B]) extends MHProposalGenerator[(A, B)] {
  self =>
  ...
  override def logTransitionProbability(from: MHSample[(A, B)], to: MHSample[(A, B)]): Double = {
    ...
    proposal1.logTransitionProbability(MHSample(from.parameters._1, from.generatedBy), MHSample(to.parameters._1, to.generatedBy)) *
      proposal2.logTransitionProbability(MHSample(from.parameters._2, from.generatedBy), MHSample(to.parameters._2, to.generatedBy))
  }
...
class MHProductProposal3[A, B, C](proposal1: MHProposalGenerator[A],
  ...
  override def logTransitionProbability(from: MHSample[(A, B, C)], to: MHSample[(A, B, C)]): Double = {
    ...
    proposal1.logTransitionProbability(MHSample(from.parameters._1, from.generatedBy), MHSample(to.parameters._1, to.generatedBy)) *
      proposal2.logTransitionProbability(MHSample(from.parameters._2, from.generatedBy), MHSample(to.parameters._2, to.generatedBy)) *
      proposal3.logTransitionProbability(MHSample(from.parameters._3, from.generatedBy), MHSample(to.parameters._3, to.generatedBy)
      )
  }
